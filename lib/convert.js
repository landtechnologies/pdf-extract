...
exports = module.exports = function convert(input_path, quality, callback) {
  ...
  fs.exists(input_path, function (exists) {
    ...
    //var output_path = path.join(__dirname,'../test/test_data/single_page_raw.tiff');
    var params = [
    ...
    var cmd = 'gs -sDEVICE=tiffgray -r720x720 -sCompression=lzw -o "' + output_path + '" "'+input_path+'"';
    //var cmd = 'convert -depth 8 -background white -alpha Off -density '+pdf_convert_quality+' "'+ input_path +'"  "' + output_path+'"';
